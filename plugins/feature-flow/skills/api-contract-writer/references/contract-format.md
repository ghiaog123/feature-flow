...
Template **bắt buộc** cho output của skill `api-contract-writer`. Sao chép cấu trúc và điền vào — không tự sáng tạo cấu trúc khác. Ví dụ dưới viết tiếng Việt; nếu user yêu cầu ngôn ngữ khác, dịch phần mô tả/heading phụ ("Mục lục" → "Table of Contents", v.v.) nhưng giữ nguyên cấu trúc.
