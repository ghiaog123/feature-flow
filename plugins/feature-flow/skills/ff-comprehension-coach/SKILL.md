...
- **A feature folder** — `docs/features/<feature>/` (proposal, ff-impl-status, test plan). Extract text from long HTML rather than reading raw:
  ```bash
  python3 -c "
  import re, html
