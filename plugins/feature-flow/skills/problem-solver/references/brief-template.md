...
Từ chẩn đoán (`assessment.md`) → giải pháp hành động được. Ghi ra `docs/features/<feature>/analysis_brief.md`. Đây là đầu vào cho `implementation-planner`.
...
## Bước tiếp theo (để implementation-planner bám)
- [ ] <hành động cụ thể>
- [ ] <...>
